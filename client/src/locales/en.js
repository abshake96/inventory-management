export default {
  ...
  restocking: {
    title: "Restocking",
    description:
      "Recommend items to restock based on demand forecasts and your budget",
    budgetLabel: "Budget",
    budgetHelp: "Drag to set your restocking budget",
    statsItems: "Items Recommended",
    statsCost: "Estimated Cost",
    statsBudgetRemaining: "Budget Remaining",
    tableTitle: "Recommended Items",
    colSku: "SKU",
    colName: "Item Name",
    colTrend: "Trend",
    colDemandGap: "Demand Gap",
    colUnitCost: "Unit Cost",
    colQty: "Restock Qty",
    colLineCost: "Line Cost",
    colInclude: "Include",
    runningTotal: "Selected Cost",
    budgetOf: "of",
    placeOrder: "Place Order",
    orderSuccess: "Order submitted successfully!",
    orderSuccessDetail:
      "Your restocking order {orderNumber} has been submitted.",
  ...
  purchaseOrder: {
    ...
    loadingError: "Failed to load purchase order details.",
    submitError: "Failed to submit purchase order. Please try again.",
  },
